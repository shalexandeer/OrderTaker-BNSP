...
// export function DialogRemoveClientUrl() {
//   const [table, setTable] = useRecoilState(tableEditorState);
//   const queryClient = useQueryClient();
  
//   const deleteMutation = useDeleteGam({
//     onSuccess: ({message}) => {
...
//         <DialogHeader>
//           <DialogTitle>Hapus Game Client {table.selectedItem.name}</DialogTitle>
//           <DialogDescription>
//             Dengan menekan tombol "Hapus", data Game Client dengan nama {table.selectedItem.name} akan dihapus secara permanen.
//           </DialogDescription>
//         </DialogHeader>
//         <DialogFooter>

...
import { DialogAddReferral } from './components/DialogAddReferral';
import { useGetReferrals } from '@/services/Referral/Referral.query';
import { DialogEditReferral } from './components/DialogEditReferral';
import { DialogRemoveReferral } from './components/DialogRemoveReferral';
 ...
 const [searchParams, setSearchParams] = useSearchParams();
  ...
  useEffect(() => {
    if (referralsData?.data?.pagination) {
      const {page, pageSize, totalPage, totalData } = referralsData.data.pagination;
      setSearchParams({
        page: page.toString(),
